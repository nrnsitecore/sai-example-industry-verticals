...
export const Pagination = ({
  ...
  setCurrentPage,
  windowSize = 3,
  paginationButtonClasses = 'px-3 py-2 md:px-4 md:py-3 rounded-lg transition-colors',
}: PaginationProps) => {
    ...
    <div className="mt-12 flex items-center justify-center space-x-2 text-sm md:space-x-4">
      {currentPage > 1 && (
        <button
          ...
          className={`${paginationButtonClasses} bg-background-muted hover:bg-background-muted/80`}
        >
        ...
        <>
          <button
            ...
            className={`${paginationButtonClasses} ${
              currentPage === 1 ? 'bg-accent text-white' : 'bg-background-muted'
            }`}
          >
            1
          </button>
        ...
        <button
          ...
          className={`${paginationButtonClasses} ${
            page === currentPage
              ...
              : 'bg-background-muted hover:bg-background-muted/80'
          }`}
        >
          {page}
        </button>
      ...
      {endPage < totalPages && (
        <>
          ...
          <button
            ...
            className={`${paginationButtonClasses} ${
              currentPage === totalPages ? 'bg-accent text-white' : 'bg-background-muted'
            }`}
          >
            {totalPages}
          </button>
