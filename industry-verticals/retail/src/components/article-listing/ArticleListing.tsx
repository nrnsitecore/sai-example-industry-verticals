    ...
    >
      <div className="container grid grid-cols-1 gap-12 lg:grid-cols-[3fr_1fr]">
        ...
        <div className="space-y-16">
          {paginatedArticles.map((article) => (
            <article key={article.id} className="space-y-4">
              {/* Image */}
              <div className="relative aspect-3/2 w-full overflow-hidden rounded-2xl md:aspect-9/4">
                <ContentSdkImage
        ...
        <div className="space-y-8 p-4">
          ...
          {/* Categories */}
          <div className="text-foreground mb-5 text-xs font-medium tracking-[0.2em] uppercase">
          ...
          <ul className="text-foreground-muted space-y-4 text-sm">
            <li className="flex justify-between">
              <button
                ...
                className={`flex-1 text-left transition-colors ${!selectedCategory ? 'text-foreground font-semibold' : ''}`}
              >
              ...
              <li key={category.name} className="flex justify-between">
                <button
                  ...
                  className={`flex-1 text-left transition-colors ${
                    selectedCategory === category.name ? 'text-foreground font-semibold' : ''
                  }`}
                >
                  {category.name}
                </button>
