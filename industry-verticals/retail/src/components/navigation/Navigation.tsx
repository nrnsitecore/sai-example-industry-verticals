    ...
    >
      <div className="flex items-center justify-center gap-1">
        <Link
          ...
          className="whitespace-nowrap transition-colors hover:opacity-80 [.component.header_&]:text-inherit"
        >
          ...
          className={clsx(
            ...
            hasDropdownMenu &&
              clsx(
                ...
                'lg:bg-dfin-navy-light [.component.header_&]:lg:bg-dfin-navy-light lg:rounded-xl lg:text-white lg:shadow-lg',
                isActive
                  ? 'max-lg:flex'
...
export const Default = ({ params, fields }: NavigationProps) => {
  ...
  return (
    <div className={`component navigation bg-transparent ${styles}`} id={id}>
      ...
      <nav
        className={clsx(
          '[.component.header_&]:bg-dfin-navy max-lg:bg-dfin-navy z-100 flex duration-300 max-lg:text-white',
