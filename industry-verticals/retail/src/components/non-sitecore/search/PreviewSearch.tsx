  ...
  return (
    <PreviewSearch.Root>
      <form ref={formRef} onSubmit={handleSubmit} className="flex-1">
        <PreviewSearch.Input
          name="query"
          className="border-border focus:border-foreground focus:ring-foreground/20 w-full rounded-full border px-4 py-2.5 text-base focus:ring-2 focus:outline-none sm:px-5 sm:py-3 sm:text-lg"
